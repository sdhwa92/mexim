...
import screenshotImage from "@/public/img/13399753_Work_7.jpg";
...
export default function FeatureWithScreenshotPanel() {
  return (
    <div
      className={`overflow-hidden ${COLOR_THEME.background.tertiary} py-24 sm:py-32`}
    >
      <div className="mx-auto max-w-7xl md:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
          ...
          <div className="sm:px-6 lg:px-0">
            <div
              className={`relative isolate overflow-hidden ${COLOR_THEME.background.primary} px-6 pt-8 sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:pl-16 sm:pr-0 sm:pt-16 lg:mx-0 lg:max-w-none`}
            >
              <div
